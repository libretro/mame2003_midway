...
static MEMORY_READ16_START( readmem )
	...
	{ TOBYTE(0x01400000), TOBYTE(0x0145ffff), midwunit_cmos_r },
	{ TOBYTE(0x01600000), TOBYTE(0x0160001f), midwunit_security_r },
	{ TOBYTE(0x01680000), TOBYTE(0x0168001f), midwunit_sound_r },
	{ TOBYTE(0x01800000), TOBYTE(0x0187ffff), midwunit_io_r },
	{ TOBYTE(0x01880000), TOBYTE(0x018fffff), MRA16_RAM },
	{ TOBYTE(0x01a00000), TOBYTE(0x01a000ff), midtunit_dma_r },
	{ TOBYTE(0x01a80000), TOBYTE(0x01a800ff), midtunit_dma_r },
	{ TOBYTE(0x01b00000), TOBYTE(0x01b0001f), midwunit_control_r },
	{ TOBYTE(0x02000000), TOBYTE(0x06ffffff), midwunit_gfxrom_r },
...
static MEMORY_WRITE16_START( writemem )
	...
	{ TOBYTE(0x01400000), TOBYTE(0x0145ffff), midwunit_cmos_w, (data16_t **)&generic_nvram, &generic_nvram_size },
	{ TOBYTE(0x01480000), TOBYTE(0x014fffff), midwunit_cmos_enable_w },
	{ TOBYTE(0x01600000), TOBYTE(0x0160001f), midwunit_security_w },
	{ TOBYTE(0x01680000), TOBYTE(0x0168001f), midwunit_sound_w },
	{ TOBYTE(0x01800000), TOBYTE(0x0187ffff), midwunit_io_w },
	{ TOBYTE(0x01880000), TOBYTE(0x018fffff), midtunit_paletteram_w, &paletteram16 },
	{ TOBYTE(0x01a00000), TOBYTE(0x01a000ff), midtunit_dma_w },
	{ TOBYTE(0x01a80000), TOBYTE(0x01a800ff), midtunit_dma_w },
	{ TOBYTE(0x01b00000), TOBYTE(0x01b0001f), midwunit_control_w },
	{ TOBYTE(0x02000000), TOBYTE(0x06ffffff), MWA16_ROM, (data16_t **)&midwunit_decode_memory },
...
ROM_START( openice )
	...
	ROM_REGION( ADSP2100_SIZE + 0x400000, REGION_CPU2, 0 )	/* ADSP-2105 data */
	ROM_LOAD( "oiceu2.bin",  ADSP2100_SIZE + 0x000000, 0x100000, CRC(8adb5aab) SHA1(4c25bc051c90947f3366f83ac5ca8dc78e26b8a4) )
	ROM_LOAD( "oiceu3.bin",  ADSP2100_SIZE + 0x100000, 0x100000, CRC(11c61ad6) SHA1(324621d6b486399b6d5ede1fed39d4e448cdeb32) )
	ROM_LOAD( "oiceu4.bin",  ADSP2100_SIZE + 0x200000, 0x100000, CRC(04279290) SHA1(daf1e57137ae1c3434194054e69809bfe3ed1fc3) )
	ROM_LOAD( "oiceu5.bin",  ADSP2100_SIZE + 0x300000, 0x100000, CRC(e90ad61f) SHA1(59eeabcae7e0e70cdb4472cde64b8a28b07ede98) )
...
ROM_START( nbahangt )
	...
	ROM_REGION( ADSP2100_SIZE + 0x400000, REGION_CPU2, 0 )	/* ADSP-2105 data */
	ROM_LOAD( "mhtu2.bin",  ADSP2100_SIZE + 0x000000, 0x100000, CRC(3f0b0d0a) SHA1(e3b8a264686ce7359d86e4926237d8cf17612991) )
	ROM_LOAD( "mhtu3.bin",  ADSP2100_SIZE + 0x100000, 0x100000, CRC(ec1db988) SHA1(1cf06d0b75f20ded7db648070e85c056043765bb) )
	ROM_LOAD( "mhtu4.bin",  ADSP2100_SIZE + 0x200000, 0x100000, CRC(c7f847a3) SHA1(c50175dffa3563ccd5792c59a6b44523f4014544) )
	ROM_LOAD( "mhtu5.bin",  ADSP2100_SIZE + 0x300000, 0x100000, CRC(ef19316a) SHA1(d41ae87ab45630a37c73684de42f7f6e0ed8f13b) )
...
ROM_START( rmpgwt )
	...
	ROM_REGION( ADSP2100_SIZE + 0x400000, REGION_CPU2, 0 )	/* ADSP-2105 data */
	ROM_LOAD( "rwt.2",  ADSP2100_SIZE + 0x000000, 0x100000, CRC(0e82f83d) SHA1(215eebb6c229ef9ad0fcbcbc6e4e07300c05654f) )
	ROM_LOAD( "rwt.3",  ADSP2100_SIZE + 0x100000, 0x100000, CRC(3ff54d15) SHA1(827805602091313ec68ea1bccf667bd3b3fc6b8b) )
	ROM_LOAD( "rwt.4",  ADSP2100_SIZE + 0x200000, 0x100000, CRC(5c7f5656) SHA1(6c9d692bad539fec8b5aa0bfb56de3ef3719c68a) )
	ROM_LOAD( "rwt.5",  ADSP2100_SIZE + 0x300000, 0x100000, CRC(fd9aaf24) SHA1(d60dc076e72618c99ecac9d081d8c49d337b90c7) )
...
ROM_START( wwfmania )
	...
	ROM_REGION( ADSP2100_SIZE + 0x400000, REGION_CPU2, 0 )	/* ADSP-2105 data */
	ROM_LOAD( "wwf.2",  ADSP2100_SIZE + 0x000000, 0x100000, CRC(a9acb250) SHA1(c1a7773ffdb86dc2c1c90c220482ed6330fcbb55) )
	ROM_LOAD( "wwf.3",  ADSP2100_SIZE + 0x100000, 0x100000, CRC(9442b6c9) SHA1(1f887c05ab9ca99078be584d7e9e6c59c8ec1818) )
	ROM_LOAD( "wwf.4",  ADSP2100_SIZE + 0x200000, 0x100000, CRC(cee78fac) SHA1(c37d3b4aef47dc80d864497b3013f03220d45482) )
	ROM_LOAD( "wwf.5",  ADSP2100_SIZE + 0x300000, 0x100000, CRC(5b31fd40) SHA1(35dcf19b223029e17616357d29dd04bbfeb83491) )
